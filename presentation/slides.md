---
theme: default
title: TJUClaw · 从校园目标到实际结果
info: 面向天津大学学生的校园行动智能体，开发阶段演示稿。
colorSchema: light
transition: none
drawings:
  persist: false
...
<div class="cover">
<div class="project-name">TJUClaw</div>
<h1>把校园问题，<br>变成可以交付的结果。</h1>
<p class="lead">面向天津大学学生的校园行动智能体</p>
<p class="status-note">开发阶段演示稿 · 校园能力与执行链路接入中</p>
</div>
...
<p class="footnote">覆盖目标来自校园需求与功能调研；本页不表示这些命令已全部可用。</p>
...
<!--
Pi SDK 的显式 Skill 加载方式已核对，产品运行时集成尚未完成。
...
任务归属与 CLI 的本地测试已通过；产品执行容器尚未完成接入。
-->
...
| CI/CD | 工具链镜像预检、配置校验通过 | 远端接入与成功流水线 |
...
<p class="closing">TJUClaw · 为校园任务提供可以核验的结果</p>
